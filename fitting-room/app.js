...
function init() {
  ...
  //   setupIdentityGate();
  // Demo-gate visitors who already spent their one measurement on this browser
  // get the "already used" screen instead of the form.
  ...
  // secondary re-measure entry points stay unwired in that mode instead of
  // offering a way around the one-time limit within a single widget open.
  if (DEMO_GATE) {
